...
void bind_Pythia8_BeamShape(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::BoseEinsteinHadron file:Pythia8/BoseEinstein.h line:26
		...
		cl.def( pybind11::init( [](Pythia8::BoseEinsteinHadron const &o){ return new Pythia8::BoseEinsteinHadron(o); } ) );
		...
		cl.def("assign", (class Pythia8::BoseEinsteinHadron & (Pythia8::BoseEinsteinHadron::*)(const class Pythia8::BoseEinsteinHadron &)) &Pythia8::BoseEinsteinHadron::operator=, "C++: Pythia8::BoseEinsteinHadron::operator=(const class Pythia8::BoseEinsteinHadron &) --> class Pythia8::BoseEinsteinHadron &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::BoseEinstein file:Pythia8/BoseEinstein.h line:48
	...
	{ // Pythia8::ColourTracing file:Pythia8/ColourTracing.h line:22
		...
		cl.def("init", (void (Pythia8::ColourTracing::*)(class Pythia8::Logger *)) &Pythia8::ColourTracing::init, "C++: Pythia8::ColourTracing::init(class Pythia8::Logger *) --> void", pybind11::arg("loggerPtrIn"));
		...
		cl.def("traceFromAcol", (bool (Pythia8::ColourTracing::*)(int, class Pythia8::Event &, int, int, class std::vector<int> &)) &Pythia8::ColourTracing::traceFromAcol, "C++: Pythia8::ColourTracing::traceFromAcol(int, class Pythia8::Event &, int, int, class std::vector<int> &) --> bool", pybind11::arg("indxCol"), pybind11::arg("event"), pybind11::arg("iJun"), pybind11::arg("iCol"), pybind11::arg("iParton"));
		cl.def("traceFromCol", (bool (Pythia8::ColourTracing::*)(int, class Pythia8::Event &, int, int, class std::vector<int> &)) &Pythia8::ColourTracing::traceFromCol, "C++: Pythia8::ColourTracing::traceFromCol(int, class Pythia8::Event &, int, int, class std::vector<int> &) --> bool", pybind11::arg("indxCol"), pybind11::arg("event"), pybind11::arg("iJun"), pybind11::arg("iCol"), pybind11::arg("iParton"));
		cl.def("traceInLoop", (bool (Pythia8::ColourTracing::*)(class Pythia8::Event &, class std::vector<int> &)) &Pythia8::ColourTracing::traceInLoop, "C++: Pythia8::ColourTracing::traceInLoop(class Pythia8::Event &, class std::vector<int> &) --> bool", pybind11::arg("event"), pybind11::arg("iParton"));
		...
		cl.def("getJunChains", (class std::vector<class std::vector<int> > (Pythia8::ColourTracing::*)(class Pythia8::Event &)) &Pythia8::ColourTracing::getJunChains, "C++: Pythia8::ColourTracing::getJunChains(class Pythia8::Event &) --> class std::vector<class std::vector<int> >", pybind11::arg("event"));
	...
	{ // Pythia8::ColSinglet file:Pythia8/FragmentationSystems.h line:31
		...
		cl.def( pybind11::init( [](class std::vector<int> & a0, class Pythia8::Vec4 const & a1, double const & a2, double const & a3){ return new Pythia8::ColSinglet(a0, a1, a2, a3); } ), "doc" , pybind11::arg("iPartonIn"), pybind11::arg("pSumIn"), pybind11::arg("massIn"), pybind11::arg("massExcessIn"));
		cl.def( pybind11::init( [](class std::vector<int> & a0, class Pythia8::Vec4 const & a1, double const & a2, double const & a3, bool const & a4){ return new Pythia8::ColSinglet(a0, a1, a2, a3, a4); } ), "doc" , pybind11::arg("iPartonIn"), pybind11::arg("pSumIn"), pybind11::arg("massIn"), pybind11::arg("massExcessIn"), pybind11::arg("hasJunctionIn"));
		cl.def( pybind11::init( [](class std::vector<int> & a0, class Pythia8::Vec4 const & a1, double const & a2, double const & a3, bool const & a4, bool const & a5){ return new Pythia8::ColSinglet(a0, a1, a2, a3, a4, a5); } ), "doc" , pybind11::arg("iPartonIn"), pybind11::arg("pSumIn"), pybind11::arg("massIn"), pybind11::arg("massExcessIn"), pybind11::arg("hasJunctionIn"), pybind11::arg("isClosedIn"));
		cl.def( pybind11::init<class std::vector<int> &, class Pythia8::Vec4, double, double, bool, bool, bool>(), pybind11::arg("iPartonIn"), pybind11::arg("pSumIn"), pybind11::arg("massIn"), pybind11::arg("massExcessIn"), pybind11::arg("hasJunctionIn"), pybind11::arg("isClosedIn"), pybind11::arg("isCollectedIn") );
		...
		cl.def_readwrite("isHandled", &Pythia8::ColSinglet::isHandled);
	...
	{ // Pythia8::ColConfig file:Pythia8/FragmentationSystems.h line:61
		...
		cl.def("insert", (bool (Pythia8::ColConfig::*)(class std::vector<int> &, class Pythia8::Event &)) &Pythia8::ColConfig::insert, "C++: Pythia8::ColConfig::insert(class std::vector<int> &, class Pythia8::Event &) --> bool", pybind11::arg("iPartonIn"), pybind11::arg("event"));
		cl.def("simpleInsert", [](Pythia8::ColConfig &o, class std::vector<int> & a0, class Pythia8::Event & a1) -> bool { return o.simpleInsert(a0, a1); }, "", pybind11::arg("iPartonIn"), pybind11::arg("event"));
		cl.def("simpleInsert", (bool (Pythia8::ColConfig::*)(class std::vector<int> &, class Pythia8::Event &, bool)) &Pythia8::ColConfig::simpleInsert, "C++: Pythia8::ColConfig::simpleInsert(class std::vector<int> &, class Pythia8::Event &, bool) --> bool", pybind11::arg("iPartonIn"), pybind11::arg("event"), pybind11::arg("fixOrder"));
