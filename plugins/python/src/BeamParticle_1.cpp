...
void bind_Pythia8_BeamParticle_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::BeamParticle file:Pythia8/BeamParticle.h line:133
		...
		cl.def("initSwitchID", (void (Pythia8::BeamParticle::*)(const class std::vector<class std::shared_ptr<class Pythia8::PDF> > &)) &Pythia8::BeamParticle::initSwitchID, "C++: Pythia8::BeamParticle::initSwitchID(const class std::vector<class std::shared_ptr<class Pythia8::PDF> > &) --> void", pybind11::arg("pdfSavePtrsIn"));
		...
		cl.def("xfMPI", (double (Pythia8::BeamParticle::*)(int, double, double, Pythia8::xfModPrepData &)) &Pythia8::BeamParticle::xfMPI, "C++: Pythia8::BeamParticle::xfMPI(int, double, double, Pythia8::xfModPrepData &) --> double", pybind11::arg("idIn"), pybind11::arg("x"), pybind11::arg("Q2"), pybind11::arg("xfData"));
		...
		cl.def("xfISR", (double (Pythia8::BeamParticle::*)(int, int, double, double, Pythia8::xfModPrepData &)) &Pythia8::BeamParticle::xfISR, "C++: Pythia8::BeamParticle::xfISR(int, int, double, double, Pythia8::xfModPrepData &) --> double", pybind11::arg("indexMPI"), pybind11::arg("idIn"), pybind11::arg("x"), pybind11::arg("Q2"), pybind11::arg("xfData"));
		...
		cl.def("remnantColours", (bool (Pythia8::BeamParticle::*)(class Pythia8::Event &, class std::vector<int> &, class std::vector<int> &)) &Pythia8::BeamParticle::remnantColours, "C++: Pythia8::BeamParticle::remnantColours(class Pythia8::Event &, class std::vector<int> &, class std::vector<int> &) --> bool", pybind11::arg("event"), pybind11::arg("colFrom"), pybind11::arg("colTo"));
		...
		cl.def("updateCol", (void (Pythia8::BeamParticle::*)(class std::vector<struct std::pair<int, int> >)) &Pythia8::BeamParticle::updateCol, "C++: Pythia8::BeamParticle::updateCol(class std::vector<struct std::pair<int, int> >) --> void", pybind11::arg("colourChanges"));
		cl.def("getColUpdates", (class std::vector<struct std::pair<int, int> > (Pythia8::BeamParticle::*)()) &Pythia8::BeamParticle::getColUpdates, "C++: Pythia8::BeamParticle::getColUpdates() --> class std::vector<struct std::pair<int, int> >");
		...
		cl.def("xfModPrep", (Pythia8::xfModPrepData (Pythia8::BeamParticle::*)(int, double)) &Pythia8::BeamParticle::xfModPrep, "C++: Pythia8::BeamParticle::xfModPrep(int, double) --> Pythia8::xfModPrepData", pybind11::arg("iSkip"), pybind11::arg("Q2"));
