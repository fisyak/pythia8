...
void bind_Pythia8_Basics_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::HistPlot file:Pythia8/Basics.h line:791
		...
		cl.def( pybind11::init( [](std::string const & a0){ return new Pythia8::HistPlot(a0); } ), "doc" , pybind11::arg("pythonName"));
		cl.def( pybind11::init<std::string, bool>(), pybind11::arg("pythonName"), pybind11::arg("useLegacyIn") );

		cl.def("frame", [](Pythia8::HistPlot &o, std::string const & a0) -> void { return o.frame(a0); }, "", pybind11::arg("frameIn"));
		cl.def("frame", [](Pythia8::HistPlot &o, std::string const & a0, std::string const & a1) -> void { return o.frame(a0, a1); }, "", pybind11::arg("frameIn"), pybind11::arg("titleIn"));
		cl.def("frame", [](Pythia8::HistPlot &o, std::string const & a0, std::string const & a1, std::string const & a2) -> void { return o.frame(a0, a1, a2); }, "", pybind11::arg("frameIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"));
		cl.def("frame", [](Pythia8::HistPlot &o, std::string const & a0, std::string const & a1, std::string const & a2, std::string const & a3) -> void { return o.frame(a0, a1, a2, a3); }, "", pybind11::arg("frameIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"), pybind11::arg("yLabIn"));
		cl.def("frame", [](Pythia8::HistPlot &o, std::string const & a0, std::string const & a1, std::string const & a2, std::string const & a3, double const & a4) -> void { return o.frame(a0, a1, a2, a3, a4); }, "", pybind11::arg("frameIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"), pybind11::arg("yLabIn"), pybind11::arg("xSizeIn"));
		...
		cl.def("add", [](Pythia8::HistPlot &o, const class Pythia8::Hist & a0, std::string const & a1) -> void { return o.add(a0, a1); }, "", pybind11::arg("histIn"), pybind11::arg("styleIn"));
		...
		cl.def("addFile", [](Pythia8::HistPlot &o, std::string const & a0) -> void { return o.addFile(a0); }, "", pybind11::arg("fileIn"));
		cl.def("addFile", [](Pythia8::HistPlot &o, std::string const & a0, std::string const & a1) -> void { return o.addFile(a0, a1); }, "", pybind11::arg("fileIn"), pybind11::arg("styleIn"));
		cl.def("addFile", [](Pythia8::HistPlot &o, std::string const & a0, std::string const & a1, std::string const & a2) -> void { return o.addFile(a0, a1, a2); }, "", pybind11::arg("fileIn"), pybind11::arg("styleIn"), pybind11::arg("legendIn"));
		...
		cl.def("plotFrame", [](Pythia8::HistPlot &o, std::string const & a0, const class Pythia8::Hist & a1) -> void { return o.plotFrame(a0, a1); }, "", pybind11::arg("frameIn"), pybind11::arg("histIn"));
		cl.def("plotFrame", [](Pythia8::HistPlot &o, std::string const & a0, const class Pythia8::Hist & a1, std::string const & a2) -> void { return o.plotFrame(a0, a1, a2); }, "", pybind11::arg("frameIn"), pybind11::arg("histIn"), pybind11::arg("titleIn"));
		cl.def("plotFrame", [](Pythia8::HistPlot &o, std::string const & a0, const class Pythia8::Hist & a1, std::string const & a2, std::string const & a3) -> void { return o.plotFrame(a0, a1, a2, a3); }, "", pybind11::arg("frameIn"), pybind11::arg("histIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"));
		cl.def("plotFrame", [](Pythia8::HistPlot &o, std::string const & a0, const class Pythia8::Hist & a1, std::string const & a2, std::string const & a3, std::string const & a4) -> void { return o.plotFrame(a0, a1, a2, a3, a4); }, "", pybind11::arg("frameIn"), pybind11::arg("histIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"), pybind11::arg("yLabIn"));
		cl.def("plotFrame", [](Pythia8::HistPlot &o, std::string const & a0, const class Pythia8::Hist & a1, std::string const & a2, std::string const & a3, std::string const & a4, std::string const & a5) -> void { return o.plotFrame(a0, a1, a2, a3, a4, a5); }, "", pybind11::arg("frameIn"), pybind11::arg("histIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"), pybind11::arg("yLabIn"), pybind11::arg("styleIn"));
		cl.def("plotFrame", [](Pythia8::HistPlot &o, std::string const & a0, const class Pythia8::Hist & a1, std::string const & a2, std::string const & a3, std::string const & a4, std::string const & a5, std::string const & a6) -> void { return o.plotFrame(a0, a1, a2, a3, a4, a5, a6); }, "", pybind11::arg("frameIn"), pybind11::arg("histIn"), pybind11::arg("titleIn"), pybind11::arg("xLabIn"), pybind11::arg("yLabIn"), pybind11::arg("styleIn"), pybind11::arg("legendIn"));
