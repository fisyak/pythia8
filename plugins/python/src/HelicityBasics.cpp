...
void bind_Pythia8_HelicityBasics(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::GammaMatrix file:Pythia8/HelicityBasics.h line:118
		...
		cl.def("__call__", (class std::complex<double> & (Pythia8::GammaMatrix::*)(int, int)) &Pythia8::GammaMatrix::operator(), "C++: Pythia8::GammaMatrix::operator()(int, int) --> class std::complex<double> &", pybind11::return_value_policy::reference, pybind11::arg("I"), pybind11::arg("J"));
		cl.def("__mul__", (class Pythia8::GammaMatrix (Pythia8::GammaMatrix::*)(class std::complex<double>)) &Pythia8::GammaMatrix::operator*, "C++: Pythia8::GammaMatrix::operator*(class std::complex<double>) --> class Pythia8::GammaMatrix", pybind11::arg("s"));
		cl.def("__sub__", (class Pythia8::GammaMatrix (Pythia8::GammaMatrix::*)(class std::complex<double>)) &Pythia8::GammaMatrix::operator-, "C++: Pythia8::GammaMatrix::operator-(class std::complex<double>) --> class Pythia8::GammaMatrix", pybind11::arg("s"));
		cl.def("__add__", (class Pythia8::GammaMatrix (Pythia8::GammaMatrix::*)(class std::complex<double>)) &Pythia8::GammaMatrix::operator+, "C++: Pythia8::GammaMatrix::operator+(class std::complex<double>) --> class Pythia8::GammaMatrix", pybind11::arg("s"));
		cl.def("assign", (class Pythia8::GammaMatrix & (Pythia8::GammaMatrix::*)(const class Pythia8::GammaMatrix &)) &Pythia8::GammaMatrix::operator=, "C++: Pythia8::GammaMatrix::operator=(const class Pythia8::GammaMatrix &) --> class Pythia8::GammaMatrix &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::HelicityParticle file:Pythia8/HelicityBasics.h line:182
		...
		cl.def("normalize", (void (Pythia8::HelicityParticle::*)(class std::vector<class std::vector<class std::complex<double> > > &)) &Pythia8::HelicityParticle::normalize, "C++: Pythia8::HelicityParticle::normalize(class std::vector<class std::vector<class std::complex<double> > > &) --> void", pybind11::arg("m"));
	...
	{ // Pythia8::HelicityMatrixElement file:Pythia8/HelicityMatrixElements.h line:24
		...
		cl.def("initChannel", (class Pythia8::HelicityMatrixElement * (Pythia8::HelicityMatrixElement::*)(class std::vector<class Pythia8::HelicityParticle> &)) &Pythia8::HelicityMatrixElement::initChannel, "C++: Pythia8::HelicityMatrixElement::initChannel(class std::vector<class Pythia8::HelicityParticle> &) --> class Pythia8::HelicityMatrixElement *", pybind11::return_value_policy::automatic, pybind11::arg(""));
		cl.def("decayWeight", (double (Pythia8::HelicityMatrixElement::*)(class std::vector<class Pythia8::HelicityParticle> &)) &Pythia8::HelicityMatrixElement::decayWeight, "C++: Pythia8::HelicityMatrixElement::decayWeight(class std::vector<class Pythia8::HelicityParticle> &) --> double", pybind11::arg(""));
		cl.def("decayWeightMax", (double (Pythia8::HelicityMatrixElement::*)(class std::vector<class Pythia8::HelicityParticle> &)) &Pythia8::HelicityMatrixElement::decayWeightMax, "C++: Pythia8::HelicityMatrixElement::decayWeightMax(class std::vector<class Pythia8::HelicityParticle> &) --> double", pybind11::arg(""));
		cl.def("calculateME", (class std::complex<double> (Pythia8::HelicityMatrixElement::*)(class std::vector<int>)) &Pythia8::HelicityMatrixElement::calculateME, "C++: Pythia8::HelicityMatrixElement::calculateME(class std::vector<int>) --> class std::complex<double>", pybind11::arg(""));
		cl.def("calculateD", (void (Pythia8::HelicityMatrixElement::*)(class std::vector<class Pythia8::HelicityParticle> &)) &Pythia8::HelicityMatrixElement::calculateD, "C++: Pythia8::HelicityMatrixElement::calculateD(class std::vector<class Pythia8::HelicityParticle> &) --> void", pybind11::arg(""));
		cl.def("calculateRho", (void (Pythia8::HelicityMatrixElement::*)(unsigned int, class std::vector<class Pythia8::HelicityParticle> &)) &Pythia8::HelicityMatrixElement::calculateRho, "C++: Pythia8::HelicityMatrixElement::calculateRho(unsigned int, class std::vector<class Pythia8::HelicityParticle> &) --> void", pybind11::arg(""), pybind11::arg(""));
		...
		cl.def("breitWigner", (class std::complex<double> (Pythia8::HelicityMatrixElement::*)(double, double, double)) &Pythia8::HelicityMatrixElement::breitWigner, "C++: Pythia8::HelicityMatrixElement::breitWigner(double, double, double) --> class std::complex<double>", pybind11::arg("s"), pybind11::arg("M"), pybind11::arg("G"));
		cl.def("sBreitWigner", (class std::complex<double> (Pythia8::HelicityMatrixElement::*)(double, double, double, double, double)) &Pythia8::HelicityMatrixElement::sBreitWigner, "C++: Pythia8::HelicityMatrixElement::sBreitWigner(double, double, double, double, double) --> class std::complex<double>", pybind11::arg("m0"), pybind11::arg("m1"), pybind11::arg("s"), pybind11::arg("M"), pybind11::arg("G"));
		cl.def("pBreitWigner", (class std::complex<double> (Pythia8::HelicityMatrixElement::*)(double, double, double, double, double)) &Pythia8::HelicityMatrixElement::pBreitWigner, "C++: Pythia8::HelicityMatrixElement::pBreitWigner(double, double, double, double, double) --> class std::complex<double>", pybind11::arg("m0"), pybind11::arg("m1"), pybind11::arg("s"), pybind11::arg("M"), pybind11::arg("G"));
		cl.def("dBreitWigner", (class std::complex<double> (Pythia8::HelicityMatrixElement::*)(double, double, double, double, double)) &Pythia8::HelicityMatrixElement::dBreitWigner, "C++: Pythia8::HelicityMatrixElement::dBreitWigner(double, double, double, double, double) --> class std::complex<double>", pybind11::arg("m0"), pybind11::arg("m1"), pybind11::arg("s"), pybind11::arg("M"), pybind11::arg("G"));
		...
		cl.def("initWaves", (void (Pythia8::HelicityMatrixElement::*)(class std::vector<class Pythia8::HelicityParticle> &)) &Pythia8::HelicityMatrixElement::initWaves, "C++: Pythia8::HelicityMatrixElement::initWaves(class std::vector<class Pythia8::HelicityParticle> &) --> void", pybind11::arg(""));
