...
// Pythia8::SigmaRPP file:Pythia8/SigmaTotal.h line:545
...
void bind_Pythia8_SigmaTotal_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::SigmaMBR file:Pythia8/SigmaTotal.h line:368
		...
		cl.def( pybind11::init( [](PyCallBack_Pythia8_SigmaMBR const &o){ return new PyCallBack_Pythia8_SigmaMBR(o); } ) );
		cl.def( pybind11::init( [](Pythia8::SigmaMBR const &o){ return new Pythia8::SigmaMBR(o); } ) );
	...
	{ // Pythia8::SigmaABMST file:Pythia8/SigmaTotal.h line:432
		...
		cl.def( pybind11::init( [](PyCallBack_Pythia8_SigmaABMST const &o){ return new PyCallBack_Pythia8_SigmaABMST(o); } ) );
		cl.def( pybind11::init( [](Pythia8::SigmaABMST const &o){ return new Pythia8::SigmaABMST(o); } ) );
	...
	{ // Pythia8::SigmaRPP file:Pythia8/SigmaTotal.h line:545
		...
		cl.def( pybind11::init( [](PyCallBack_Pythia8_SigmaRPP const &o){ return new PyCallBack_Pythia8_SigmaRPP(o); } ) );
		cl.def( pybind11::init( [](Pythia8::SigmaRPP const &o){ return new Pythia8::SigmaRPP(o); } ) );
	...
	{ // Pythia8::SigmaLowEnergy file:Pythia8/SigmaLowEnergy.h line:22
		...
		cl.def( pybind11::init( [](PyCallBack_Pythia8_SigmaLowEnergy const &o){ return new PyCallBack_Pythia8_SigmaLowEnergy(o); } ) );
		cl.def( pybind11::init( [](Pythia8::SigmaLowEnergy const &o){ return new Pythia8::SigmaLowEnergy(o); } ) );
		...
		cl.def("sigmaPartial", (bool (Pythia8::SigmaLowEnergy::*)(int, int, double, double, double, class std::vector<int> &, class std::vector<double> &)) &Pythia8::SigmaLowEnergy::sigmaPartial, "C++: Pythia8::SigmaLowEnergy::sigmaPartial(int, int, double, double, double, class std::vector<int> &, class std::vector<double> &) --> bool", pybind11::arg("idA"), pybind11::arg("idB"), pybind11::arg("eCM"), pybind11::arg("mA"), pybind11::arg("mB"), pybind11::arg("procsOut"), pybind11::arg("sigmasOut"));
