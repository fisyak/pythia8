...
void bind_Pythia8_Analysis(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::Sphericity file:Pythia8/Analysis.h line:27
		...
		cl.def( pybind11::init( [](Pythia8::Sphericity const &o){ return new Pythia8::Sphericity(o); } ) );
		...
		cl.def("assign", (class Pythia8::Sphericity & (Pythia8::Sphericity::*)(const class Pythia8::Sphericity &)) &Pythia8::Sphericity::operator=, "C++: Pythia8::Sphericity::operator=(const class Pythia8::Sphericity &) --> class Pythia8::Sphericity &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::Thrust file:Pythia8/Analysis.h line:80
		...
		cl.def( pybind11::init( [](Pythia8::Thrust const &o){ return new Pythia8::Thrust(o); } ) );
		...
		cl.def("assign", (class Pythia8::Thrust & (Pythia8::Thrust::*)(const class Pythia8::Thrust &)) &Pythia8::Thrust::operator=, "C++: Pythia8::Thrust::operator=(const class Pythia8::Thrust &) --> class Pythia8::Thrust &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	...
	{ // Pythia8::ClusterJet file:Pythia8/Analysis.h line:179
		...
		cl.def( pybind11::init( [](std::string const & a0){ return new Pythia8::ClusterJet(a0); } ), "doc" , pybind11::arg("measureIn"));
		cl.def( pybind11::init( [](std::string const & a0, int const & a1){ return new Pythia8::ClusterJet(a0, a1); } ), "doc" , pybind11::arg("measureIn"), pybind11::arg("selectIn"));
		cl.def( pybind11::init( [](std::string const & a0, int const & a1, int const & a2){ return new Pythia8::ClusterJet(a0, a1, a2); } ), "doc" , pybind11::arg("measureIn"), pybind11::arg("selectIn"), pybind11::arg("massSetIn"));
		cl.def( pybind11::init( [](std::string const & a0, int const & a1, int const & a2, bool const & a3){ return new Pythia8::ClusterJet(a0, a1, a2, a3); } ), "doc" , pybind11::arg("measureIn"), pybind11::arg("selectIn"), pybind11::arg("massSetIn"), pybind11::arg("preclusterIn"));
		...
		cl.def( pybind11::init( [](Pythia8::ClusterJet const &o){ return new Pythia8::ClusterJet(o); } ) );
		...
		cl.def("assign", (class Pythia8::ClusterJet & (Pythia8::ClusterJet::*)(const class Pythia8::ClusterJet &)) &Pythia8::ClusterJet::operator=, "C++: Pythia8::ClusterJet::operator=(const class Pythia8::ClusterJet &) --> class Pythia8::ClusterJet &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	...
	{ // Pythia8::SingleCellJet file:Pythia8/Analysis.h line:282
		...
		cl.def( pybind11::init( [](Pythia8::SingleCellJet const &o){ return new Pythia8::SingleCellJet(o); } ) );
		...
		cl.def("assign", (class Pythia8::SingleCellJet & (Pythia8::SingleCellJet::*)(const class Pythia8::SingleCellJet &)) &Pythia8::SingleCellJet::operator=, "C++: Pythia8::SingleCellJet::operator=(const class Pythia8::SingleCellJet &) --> class Pythia8::SingleCellJet &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::CellJet file:Pythia8/Analysis.h line:307
		...
		cl.def("assign", (class Pythia8::CellJet & (Pythia8::CellJet::*)(const class Pythia8::CellJet &)) &Pythia8::CellJet::operator=, "C++: Pythia8::CellJet::operator=(const class Pythia8::CellJet &) --> class Pythia8::CellJet &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
}
