...
void bind_Pythia8_PythiaParallel(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::PythiaParallel file:Pythia8/PythiaParallel.h line:18
		...
		cl.def( pybind11::init( [](std::string const & a0){ return new Pythia8::PythiaParallel(a0); } ), "doc" , pybind11::arg("xmlDir"));
		cl.def( pybind11::init<std::string, bool>(), pybind11::arg("xmlDir"), pybind11::arg("printBanner") );

		cl.def_readonly("pythiaHelper", &Pythia8::PythiaParallel::pythiaHelper);
		cl.def("readString", [](Pythia8::PythiaParallel &o, std::string const & a0) -> bool { return o.readString(a0); }, "", pybind11::arg("setting"));
		...
		cl.def("readFile", [](Pythia8::PythiaParallel &o, std::string const & a0) -> bool { return o.readFile(a0); }, "", pybind11::arg("fileName"));
		cl.def("readFile", [](Pythia8::PythiaParallel &o, std::string const & a0, bool const & a1) -> bool { return o.readFile(a0, a1); }, "", pybind11::arg("fileName"), pybind11::arg("warn"));
		...
		cl.def("flag", (bool (Pythia8::PythiaParallel::*)(std::string)) &Pythia8::PythiaParallel::flag, "C++: Pythia8::PythiaParallel::flag(std::string) --> bool", pybind11::arg("key"));
		cl.def("mode", (int (Pythia8::PythiaParallel::*)(std::string)) &Pythia8::PythiaParallel::mode, "C++: Pythia8::PythiaParallel::mode(std::string) --> int", pybind11::arg("key"));
		cl.def("parm", (double (Pythia8::PythiaParallel::*)(std::string)) &Pythia8::PythiaParallel::parm, "C++: Pythia8::PythiaParallel::parm(std::string) --> double", pybind11::arg("key"));
		cl.def("word", (std::string (Pythia8::PythiaParallel::*)(std::string)) &Pythia8::PythiaParallel::word, "C++: Pythia8::PythiaParallel::word(std::string) --> std::string", pybind11::arg("key"));
		...
		cl.def("run", (class std::vector<long> (Pythia8::PythiaParallel::*)(long, class std::function<void (class Pythia8::Pythia *)>)) &Pythia8::PythiaParallel::run, pybind11::call_guard<pybind11::gil_scoped_release>(), "C++: Pythia8::PythiaParallel::run(long, class std::function<void (class Pythia8::Pythia *)>) --> class std::vector<long>", pybind11::arg("nEvents"), pybind11::arg("callback"));
		cl.def("run", (class std::vector<long> (Pythia8::PythiaParallel::*)(class std::function<void (class Pythia8::Pythia *)>)) &Pythia8::PythiaParallel::run, pybind11::call_guard<pybind11::gil_scoped_release>(), "C++: Pythia8::PythiaParallel::run(class std::function<void (class Pythia8::Pythia *)>) --> class std::vector<long>", pybind11::arg("callback"));
	...
	{ // Pythia8::EventInfo file:Pythia8/HIBasics.h line:25
		...
		cl.def("assign", (class Pythia8::EventInfo & (Pythia8::EventInfo::*)(const class Pythia8::EventInfo &)) &Pythia8::EventInfo::operator=, "C++: Pythia8::EventInfo::operator=(const class Pythia8::EventInfo &) --> class Pythia8::EventInfo &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::Nucleon file:Pythia8/HINucleusModel.h line:28
		...
		pybind11::enum_<Pythia8::Nucleon::Status>(cl, "Status", pybind11::arithmetic(), "")
			.value("UNWOUNDED", Pythia8::Nucleon::UNWOUNDED)
			.value("ELASTIC", Pythia8::Nucleon::ELASTIC)
			.value("DIFF", Pythia8::Nucleon::DIFF)
			.value("ABS", Pythia8::Nucleon::ABS)
			.export_values();
		...
		cl.def("state", (const class std::vector<double> & (Pythia8::Nucleon::*)() const) &Pythia8::Nucleon::state, "C++: Pythia8::Nucleon::state() const --> const class std::vector<double> &", pybind11::return_value_policy::reference);
		cl.def("altState", [](Pythia8::Nucleon &o) -> const std::vector<double> & { return o.altState(); }, "", pybind11::return_value_policy::reference);
		cl.def("altState", (const class std::vector<double> & (Pythia8::Nucleon::*)(int)) &Pythia8::Nucleon::altState, "C++: Pythia8::Nucleon::altState(int) --> const class std::vector<double> &", pybind11::return_value_policy::reference, pybind11::arg("i"));
		...
		cl.def("state", (void (Pythia8::Nucleon::*)(const class std::vector<double> &)) &Pythia8::Nucleon::state, "C++: Pythia8::Nucleon::state(const class std::vector<double> &) --> void", pybind11::arg("s"));
		cl.def("addAltState", (void (Pythia8::Nucleon::*)(const class std::vector<double> &)) &Pythia8::Nucleon::addAltState, "C++: Pythia8::Nucleon::addAltState(const class std::vector<double> &) --> void", pybind11::arg("s"));
	...
	{ // Pythia8::Nucleus file:Pythia8/HINucleusModel.h line:152
		...
		cl.def( pybind11::init<class std::vector<class Pythia8::Nucleon>, class Pythia8::Vec4>(), pybind11::arg("nucleons"), pybind11::arg("bPos") );

		cl.def( pybind11::init( [](Pythia8::Nucleus const &o){ return new Pythia8::Nucleus(o); } ) );
	...
	{ // Pythia8::NucleusModel file:Pythia8/HINucleusModel.h line:198
		...
		cl.def("generate", (class std::vector<class Pythia8::Nucleon> (Pythia8::NucleusModel::*)() const) &Pythia8::NucleusModel::generate, "C++: Pythia8::NucleusModel::generate() const --> class std::vector<class Pythia8::Nucleon>");
