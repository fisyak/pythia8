...
void bind_Pythia8_TimeShower(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::TimeShower file:Pythia8/TimeShower.h line:33
		...
		cl.def("prepareProcess", (void (Pythia8::TimeShower::*)(class Pythia8::Event &, class Pythia8::Event &, class std::vector<int> &)) &Pythia8::TimeShower::prepareProcess, "C++: Pythia8::TimeShower::prepareProcess(class Pythia8::Event &, class Pythia8::Event &, class std::vector<int> &) --> void", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
		...
		cl.def("resonanceShower", [](Pythia8::TimeShower &o, class Pythia8::Event & a0, class Pythia8::Event & a1, class std::vector<int> & a2) -> bool { return o.resonanceShower(a0, a1, a2); }, "", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
		cl.def("resonanceShower", (bool (Pythia8::TimeShower::*)(class Pythia8::Event &, class Pythia8::Event &, class std::vector<int> &, double)) &Pythia8::TimeShower::resonanceShower, "C++: Pythia8::TimeShower::resonanceShower(class Pythia8::Event &, class Pythia8::Event &, class std::vector<int> &, double) --> bool", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
		...
		cl.def("getStateVariables", (class std::map<std::string, double> (Pythia8::TimeShower::*)(const class Pythia8::Event &, int, int, int, std::string)) &Pythia8::TimeShower::getStateVariables, "C++: Pythia8::TimeShower::getStateVariables(const class Pythia8::Event &, int, int, int, std::string) --> class std::map<std::string, double>", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
		...
		cl.def("getSplittingName", (class std::vector<std::string > (Pythia8::TimeShower::*)(const class Pythia8::Event &, int, int, int)) &Pythia8::TimeShower::getSplittingName, "C++: Pythia8::TimeShower::getSplittingName(const class Pythia8::Event &, int, int, int) --> class std::vector<std::string >", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
		...
		cl.def("getRecoilers", (class std::vector<int> (Pythia8::TimeShower::*)(const class Pythia8::Event &, int, int, std::string)) &Pythia8::TimeShower::getRecoilers, "C++: Pythia8::TimeShower::getRecoilers(const class Pythia8::Event &, int, int, std::string) --> class std::vector<int>", pybind11::arg(""), pybind11::arg(""), pybind11::arg(""), pybind11::arg(""));
	...
	{ // Pythia8::Wave4 file:Pythia8/HelicityBasics.h line:24
		...
		cl.def( pybind11::init<class std::complex<double>, class std::complex<double>, class std::complex<double>, class std::complex<double>>(), pybind11::arg("v0"), pybind11::arg("v1"), pybind11::arg("v2"), pybind11::arg("v3") );
		...
		cl.def("__call__", (class std::complex<double> & (Pythia8::Wave4::*)(int)) &Pythia8::Wave4::operator(), "C++: Pythia8::Wave4::operator()(int) --> class std::complex<double> &", pybind11::return_value_policy::reference, pybind11::arg("i"));
		...
		cl.def("__neg__", (class Pythia8::Wave4 (Pythia8::Wave4::*)()) &Pythia8::Wave4::operator-, "C++: Pythia8::Wave4::operator-() --> class Pythia8::Wave4");
		cl.def("__mul__", (class std::complex<double> (Pythia8::Wave4::*)(class Pythia8::Wave4)) &Pythia8::Wave4::operator*, "C++: Pythia8::Wave4::operator*(class Pythia8::Wave4) --> class std::complex<double>", pybind11::arg("w"));
		cl.def("__mul__", (class Pythia8::Wave4 (Pythia8::Wave4::*)(class std::complex<double>)) &Pythia8::Wave4::operator*, "C++: Pythia8::Wave4::operator*(class std::complex<double>) --> class Pythia8::Wave4", pybind11::arg("s"));
		...
		cl.def("__truediv__", (class Pythia8::Wave4 (Pythia8::Wave4::*)(class std::complex<double>)) &Pythia8::Wave4::operator/, "C++: Pythia8::Wave4::operator/(class std::complex<double>) --> class Pythia8::Wave4", pybind11::arg("s"));
		cl.def("__truediv__", (class Pythia8::Wave4 (Pythia8::Wave4::*)(double)) &Pythia8::Wave4::operator/, "C++: Pythia8::Wave4::operator/(double) --> class Pythia8::Wave4", pybind11::arg("s"));
